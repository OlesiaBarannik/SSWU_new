...
def display_cv(cv):
    ...
    print(f"Region: {cv['personal_info']['region']}")
    ...
    for job in cv['experience']:
        print(f"  {job['position']} at {job['company']} ({job['period']})")
        print("    Tasks:")
    ...
    print("\nEducation:")
    print(
        f"  {cv['education']['degree']} at {cv['education']['university']} (Graduated: {cv['education']['graduation_year']})")
